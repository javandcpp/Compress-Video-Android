...
public class MainActivity extends Activity {
    ...
    public void compress(View view) {
        ...
        MediaProcess.getMediaProcess().getVideoCompress().videoCompress("/mnt/sdcard/test.mp4", "/mnt/sdcard/output.mp4", 568, 320, new VideoCompress.CompressListener() {
            @Override
